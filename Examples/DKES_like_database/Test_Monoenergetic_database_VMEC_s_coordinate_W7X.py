...
eq=os.path.join(current_path,'../inputs/wout_W7-X_standard_configuration.nc')
booz=os.path.join(current_path, '../inputs/boozmn_wout_W7-X_standard_configuration.nc')
vmec=eq
...
file=h5.File('Dij_NEOPAX_FULL_S_NEW_W7X.h5','w')
file['rho']=rho
file['nu_v']=nu_v
file['Er']=Er
